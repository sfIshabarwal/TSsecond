...
function DateTimeFormat(target, propertyKey) {
    ...
    descriptor.value = function () {
        ...
        var formattedDate = this.formatDate(this[propertyKey]);
        console.log("Formatted ".concat(propertyKey, ": ").concat(formattedDate));
...
var UsertheTables = /** @class */ (function () {
    ...
    UsertheTables.prototype.formatDate = function (date) {
